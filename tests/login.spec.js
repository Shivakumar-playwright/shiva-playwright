...
test.describe("verify login functionality",{tag:"@smoke"}, async () => {
   ...
   test("verify login functionality with valid username and invalid password", async () => {
      // await page.goto("https://www.saucedemo.com/v1/");
      await page.locator('input[type="text"]').fill("standard_user")
   ...
   test("verify login functionality with invalid username and valid password", async () => {
      // await page.goto("https://www.saucedemo.com/v1/");
   ...
   test("verify login functionality with invalid username and invalid password", async () => {
      // await page.goto("https://www.saucedemo.com/v1/");
      await page.locator('input[type="text"]').fill("standard_userrr")
